...
- por compatibilidade temporaria, os playbooks tambem aceitam os aliases `Bearer token`, `bearer_token`, `Service token api`, `service_token_api` e a env `LEAKGUARD_AGENT_API_BEARER_TOKEN`
